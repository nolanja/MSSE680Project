...
namespace NewCustomerIntegration.Services
{
        ...
        public interface INewCustomerOrganizationService : IService
        {
            // Organization Service Interfaces
            void StoreOrganizations(Organization organizations);
            ArrayList RetrieveOrganizations();
        ...
        public interface INewCustomerAddressService : IService
        {
            // Address Service Interfaces
            void StoreAddresses(Address addresses);
            ArrayList RetrieveAddresses();
        ...
        public interface INewCustomerPersonService : IService
        {
            // Person Service Interfaces
            void StorePeople(Person people);
            ArrayList RetrievePeople();
        ...
        public interface INewCustomerSiteService : IService
        {
            // Site Service Interfaces
            void StoreSites(Site sites);
            ArrayList RetrieveSites();
        ...
        public interface INewCustomerSiteTypeService : IService
        {
            // Site Type Service Interfaces
            void StoreSiteTypes(SiteType siteTypes);
            ArrayList RetrieveSiteTypes();
        ...
        public interface INewCustomerUserTypeService : IService
        {
            // User Type Service Interfaces
            void StoreUserTypes(UserType userTypes);
            ArrayList RetrieveUserTypes();
        ...
        public interface INewCustomerRuleService : IService
        {
            // Rule Service Interfaces
            void StoreRules(NewCustomerIntegration.Domain.Models.Rule rule);
            ArrayList RetrieveRules();
